...
During the break the schoolchildren, boys and girls,
formed a queue of n people in the canteen. Initially the children stood in the order they entered the canteen.
However, after a while the boys started feeling awkward for standing in front of the girls in the queue and
...
def main():
    ...
    for _ in range(t):
        ...
        for i in range(0,n-1):
            #print(s[i],s[i+1])
            if s[i]=='B' and s[i+1] == 'G' and i > latestSwapIndex:
